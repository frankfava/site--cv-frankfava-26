...
export const buildRoleStructure = (roleTitle: string) =>
	({
		brief: {
			...
			content: async () => import("@/components/blueprints/roles/_shared/Pitch.astro"),
		},
		featuredSkills: {
			...
			content: async () => import("@/components/blueprints/roles/_shared/FeaturedSkills.astro"),
		},
		featuredProjects: {
			...
			content: async () => import("@/components/blueprints/roles/_shared/FeaturedProjects.astro"),
		},
		certifications: {
			...
			content: async () => import("@/components/blueprints/roles/_shared/Certifications.astro"),
		},
		transferableSkills: {
			...
			content: async () => import("@/components/blueprints/roles/_shared/TransferableSkills.astro"),
		},
		mappings: {
			...
			content: async () => import("@/components/blueprints/roles/_shared/Mappings.astro"),
		},
		caseStudies: {
			title: "Case Studies",
			...
			content: async () => import("@/components/blueprints/roles/_shared/CaseStudies.astro"),
		},
